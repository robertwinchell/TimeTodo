...
public class DBAdapter {
	...
	public Cursor gettask_list(String task_date) throws SQLException {

		open();

		Cursor mCursor = db.rawQuery(
				"select * FROM timetodo where task_date=='" + task_date + "'",
				null);
	...
	public Cursor get_Alltask_list() throws SQLException {

		open();

		Cursor mCursor = db.rawQuery("select * FROM timetodo", null);
