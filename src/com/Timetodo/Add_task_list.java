...
public class Add_task_list extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Share.quick_task.add("I Want go to Hospital ");
		Share.quick_task.add("I Want go to ATM ");
		Share.quick_task.add("I Want go to Bank ");
		Share.quick_task.add("I Want to Restaurant ");
		Share.quick_task.add("I Want go to Mall ");
		Share.quick_task.add("I Want go to Hotel ");
		Share.quick_task.add("I Want go to Hostel ");
		Share.quick_task.add("I Want go to Garden ");
		Share.quick_task.add("I Want go to Beach ");
